...
export function Options()
{
	...
	{
		let getYoutubeTitle = require('get-youtube-title');
		getYoutubeTitle(value, function (err, title) {
		console.log(title);
		return title;
	});
		// getYoutubeTitle(value, function (err, title) {
		  ...
		  <div className="options-wrapper">
			...
			<div className="box">
			  <div className="column" id="text-box-left">
				  <div>
				  <div className="row">
					  <span><input className="slide-up-left" id='create' type="text" placeholder="URL HERE" />
			  ...
			  <div className="column" id="text-box-right">
				  <div className="row">
					  <span><input className="slide-up-right" id='join' type="text" placeholder="URL HERE" />
					  <label htmlFor="card">ENTER</label></span>
			  </div>
			  </div>
			  </div>

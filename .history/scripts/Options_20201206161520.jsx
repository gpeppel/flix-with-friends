		  ...
		  <div className="options-wrapper">
			...
			<div className="box">
			  <div className="column" id="text-box-left">
				  <div>
				  <div className="row">
					  <span><input className="slide-up-left" onKeyUp={onKeyUp} id='playlist' type="text" placeholder="URL HERE" />
			  ...
			  <div className="column" id="text-box-right">
				  <div className="row">
					  <span><input className="slide-up-right" onKeyUp={onKeyUp} id='roomCode' type="text" placeholder="CODE HERE" />
			...
			<div className="box">
				<div className="column" id="box-left">
					<AwesomeButtonProgress type='twitter2' onPress={onRoomNewClick} loadingLabel='I HOPE NOTHING BREAKS..' releaseDelay='600' resultLabel='FOR A SECOND TIME'
						 >
					CREATE NEW VIEWING ROOM!
					</AwesomeButtonProgress>
				</div>
				<div className="column" id="box-right">	
					<AwesomeButtonProgress type='whatsapp' onPress={onRoomJoinClick} loadingLabel='JOINING...' releaseDelay='600' resultLabel='FOUND FRIENDS!'
						>
